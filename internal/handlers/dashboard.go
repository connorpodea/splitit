...
func viewGroups(groups []models.Group, groupInvitations []models.GroupInvitation, userID string, memberCounts map[string]int) string {
	...
	if len(groups) == 0 {
        ...
        <div class="friend-actions">
          ...
          <button class="remove" title="Leave group" onclick="confirmLeaveGroup('` + g.ID + `','` + strings.ReplaceAll(g.Name, "'", "") + `')">
    ...
    <div style="padding:16px;display:flex;flex-direction:column;gap:14px;">
      <div>
        ...
        <div style="display:flex;gap:8px;">
          <input class="modal-inp" id="settings-name" value="` + name + `" placeholder="Your name" />
      ...
      <div>
        ...
        <div style="display:flex;gap:8px;">
          <input class="modal-inp" id="settings-email" type="email" value="` + email + `" placeholder="email@example.com" />
      ...
      <div>
        ...
        <div style="display:flex;gap:8px;">
          <input class="modal-inp" id="settings-phone" type="tel" value="` + phone + `" placeholder="123-456-7890" />
